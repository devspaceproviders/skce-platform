#!/usr/bin/env -S node
import type { Contract as End } from '../../snapshots/53ea7f0e9edc920b2b77541af1ca06b539416553d3fc008daa9a30d4dcadb41b/contract';
import endContract from '../../snapshots/53ea7f0e9edc920b2b77541af1ca06b539416553d3fc008daa9a30d4dcadb41b/contract.json' with { type: 'json' };
...
export default class M extends Migration<Start, End> {
  ...
  override get operations() {
    return [
      this.dropDefault({ schema: 'public', table: 'enrollment', column: 'enrolledAt' }),
      this.createTable({
        schema: 'public',
